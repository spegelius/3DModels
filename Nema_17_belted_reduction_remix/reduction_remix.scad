...
module gearbox(bridging=true) {
    union() {
        difference() {
            union() {
                translate([0,29,0])
                import("Gearbox_for_nema17_extruder.stl",convexity=10);
        ...
        difference() {
            union() {
                ...
                translate([0,0,5.7-2])
                cylinder(d1=bearing_hole+1,d2=bearing_hole+4.5,h=2,$fn=60);
            }
            translate([0,0,0.3])
    ...
    difference() {
        union() {
            difference() {
                ...
                import("Gearbox_for_nema17_extruder_cover.stl",convexity=10);
        ...
        difference() {
            union() {
                hull() {
                    ...
                    chamfered_cube_side(12,42,7,4,center=true);
                ...
                intersection() {
                    ...
                    chamfered_cube(52,42,100,4,center=true);
                }
            }
            // bearing hole
            translate([3,0,5]) {
