...
module p1() {
    ...
    rotate([-135, 0, 0])
    import("../_downloaded/Superstrings_puzzle/Superstrings_628_03_003_S1.stl",
    convexity=5);
}
...
module p2(infill=true) {
    ...
    difference() {
        ...
        import("../_downloaded/Superstrings_puzzle/Superstrings_628_03_003_S2.stl",
        convexity=5);
...
module p2_supports() {
    ...
    union() {
        intersection() {
            rotate([0, 7.5])
            tube(d=10, h=100, wall=0.55,
                center=true, $fn=40);

            translate([0, 0, (4 * block - 0.6)/2])
            cube([40, 40, 4 * block - 0.6],
                center=true);
        }
        translate([3.1, 0, 4 * block - 0.6 - 1])
