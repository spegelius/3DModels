...
module tronxy_E3D_mount() {
    difference() {
        ...
        translate([-23.5,3,0]) cube([20,50,25]);
        translate([70.5,4,0]) cube([20,50,25]);
        translate([72.5,-4,0]) cube([20,50,25]);
    }
    %translate([1.5,3,11.5]) rotate([-90,180,0]) tronxy_belt_clip_left_bottom();
    %translate([65.5,6,11.5]) rotate([-90,0,0]) tronxy_belt_clip_right_top();
    
    %translate([-15,3,0]) rotate([-90,0,0]) tronxy_belt_clip_left_top();
