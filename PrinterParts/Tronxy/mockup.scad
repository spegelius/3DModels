...
module debug_motor_mount_remix() {
    ...
    //rotate([0,0,90])
    //import("../../_downloaded/Tronxy_X5S_nema_mounting/equerre_moteur_X.STL");

    //translate([530/2-45,500/2-20,575])
    //rotate([0,180,-90]) //import("../../_downloaded/Tronxy_X5S_nema_mounting/Sym_equerre_moteur_X.STL");
    ...
    %translate([-530/2+13,500/2+22,575])
    cylinder(d=12,h=10,$fn=30);

    %translate([530/2-13,500/2+22,585])
    cylinder(d=12,h=10,$fn=30);
}
