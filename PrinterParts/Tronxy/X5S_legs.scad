...
module leg() {
    ...
    difference() {
        union() {
            ...
            translate([-10, 60/2, 200 - 7/2])
            chamfered_cube_side(
                20, 60, 7, 1.5, center=true
            );

            translate([60/2, -10, 200 - 7/2])
            chamfered_cube_side(
                60, 20, 7, 1.5, center=true
            );
            ...
            translate([60, -20, 200 - 7])
            rotate([-5, -155, 0])
            chamfered_cube_side(10, 5, 130, 1.5);

            translate([-15, 60, 200 - 7])
            rotate([5, -155, 90])
            chamfered_cube_side(10, 5,130, 1.5);
        }
        cylinder(
            d=pylon_dia - 10, h=200 - 7, $fn=80
        );
