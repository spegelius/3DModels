...
M350 E16:16 I0                                  ; configure microstepping with interpolation
...
M201 X1500.00 Y1500.00 Z150.00 E8000.00:8000.00 ; set accelerations (mm/s^2)
...
M950 F1 C"Fan1" Q500                             ; Create Fan2, set  PWM signal inversion and frequency
...
G10 P4 X0 Y0 Z0                                    ; Set tool 1 axis offsets
G10 P5 X0 Y0 Z0                                    ; Set tool 1 axis offsets
...
G10 P4 R0 S0                                       ; Set initial tool 1 active and standby temperatures to 0C
G10 P5 R0 S0                                       ; Set initial tool 1 active and standby temperatures to 0C
